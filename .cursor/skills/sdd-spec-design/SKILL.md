...
If both this skill and `.agents/skills/sdd-spec-design` are listed, **this file governs dispatch**. Domain rules still come from the canonical SKILL.md. Do not rewrite those rules here.
